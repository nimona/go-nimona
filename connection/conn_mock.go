...
func (_m *MockConn) GetAddress() *address.Address {
	ret := _m.Called()

	var r0 *address.Address
	if rf, ok := ret.Get(0).(func() *address.Address); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
// ReadToken provides a mock function with given fields:
func (_m *MockConn) ReadToken() ([]byte, error) {
	ret := _m.Called()
...
// WriteToken provides a mock function with given fields: bs
func (_m *MockConn) WriteToken(bs []byte) error {
	ret := _m.Called(bs)
