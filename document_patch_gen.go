...
func (t *DocumentPatch) MarshalCBOR(w io.Writer) error {
	if t == nil {
	...
	// t.Operations ([]nimona.DocumentPatchOperation) (slice)
	if !zero.IsZeroVal(t.Operations) {
...
func (t *DocumentPatch) UnmarshalCBOR(r io.Reader) (err error) {
	if t == nil {
		*t = DocumentPatch{}
	}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("DocumentPatch: map struct too large (%d)", extra)
	}
	...
	for i := uint64(0); i < n; i++ {
		...
		case "operations":
			...
			if extra > 0 {
				t.Operations = make([]DocumentPatchOperation, extra)
			}

			for i := 0; i < int(extra); i++ {

				var v DocumentPatchOperation
				if err := v.UnmarshalCBOR(cr); err != nil {
					return err
				}
...
func (t *DocumentPatchOperation) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
...
func (t *DocumentPatchOperation) UnmarshalCBOR(r io.Reader) (err error) {
	if t == nil {
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("DocumentPatchOperation: map struct too large (%d)", extra)
	}
