...
// MockNegotiator is an autogenerated mock type for the Negotiator type
type MockNegotiator struct {
	mock.Mock
}

// Name provides a mock function with given fields:
func (_m *MockNegotiator) Name() string {
	ret := _m.Called()
...
func (_m *MockNegotiator) Negotiate(ctx context.Context, conn Conn) (context.Context, Conn, error) {
