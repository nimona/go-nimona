...
$(eval $(call tool,golangci-lint,github.com/golangci/golangci-lint/cmd/golangci-lint@v1.46.2))
...
$(eval $(call tool,go-mod-upgrade,github.com/oligot/go-mod-upgrade@v0.8.0))
