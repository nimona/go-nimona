...
func (_m *MockMessenger) Handle(contentType string, h BlockHandler) error {
...
// Send provides a mock function with given fields: ctx, block
func (_m *MockMessenger) Send(ctx context.Context, block *Block) error {
