...
func (_m *MockExchange) Get(ctx context.Context, id string) (*primitives.Block, error) {
	ret := _m.Called(ctx, id)

	var r0 *primitives.Block
	if rf, ok := ret.Get(0).(func(context.Context, string) *primitives.Block); ok {
		r0 = rf(ctx, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*primitives.Block)
		}
	}
...
func (_m *MockExchange) Send(ctx context.Context, block *primitives.Block, recipients ...string) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *primitives.Block, ...string) error); ok {
