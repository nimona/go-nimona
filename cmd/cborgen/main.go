...
func main() {
	...
	addMapping("document_patch_gen.go", nimona.DocumentPatch{})
	addMapping("document_patch_gen.go", nimona.DocumentPatchOperation{})
	...
	addMapping("handler_document_graph_gen.go", nimona.DocumentGraphRequest{})
	addMapping("handler_document_graph_gen.go", nimona.DocumentGraphResponse{})
	addMapping("handler_network_gen.go", nimona.NetworkAnnouncePeerRequest{})
	addMapping("handler_network_gen.go", nimona.NetworkAnnouncePeerResponse{})
	...
	addMapping("handler_network_gen.go", nimona.NetworkLookupPeerRequest{})
	addMapping("handler_network_gen.go", nimona.NetworkLookupPeerResponse{})
