...
type codegenFixture struct {
	Metadata       Metadata          `nimona:"$metadata,omitempty,type=foo"`
	...
	MapPtr         *codegenFixture   `nimona:"mapPtr,omitempty"`
	...
	RepeatedMap    []codegenFixture  `nimona:"repeatedmap,omitempty"`
	RepeatedMapPtr []*codegenFixture `nimona:"repeatedmapPtr,omitempty"`
}

// nolint: unused // used in tests
type codegenFixtureWithType struct {
