...
func (_m *MockMessenger) Pack(extension string, payloadType string, payload interface{}, recipient string, hideSender bool, hideRecipients bool) ([]byte, error) {
...
func (_m *MockMessenger) Send(ctx context.Context, extension string, payloadType string, payload interface{}, recipients []string) error {
